...
public class Motor {
	...
	/**
	 * Obt� les dades de mostra del programa de fitxers de text.
	 * 
	 */
	...
	public void enviarMissatgeJugPista(int equip,String m) {
        ...
        public void generarAmonestacio(int arbitre,int equip,int dorsal){
            Equip eq = equips.get(equip);
            Jugador jug = eq.getJugador(dorsal);
            Arbitre a = arbitres.get(arbitre);
            
            a.crearAmonestacio(eq, jug);
